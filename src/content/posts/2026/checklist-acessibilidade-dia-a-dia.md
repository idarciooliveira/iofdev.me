...
Acessibilidade quebra no detalhe do dia a dia: um `div` clicável, um contraste esquecido, um foco invisível. Um checklist curto, aplicado em cada PR, vale mais que uma auditoria por ano.

## O checklist

### 1. HTML semântico

Use `button`, `nav`, `main`, `h1`–`h3` em ordem. Leitores de ecrã navegam pela estrutura. Um `div onClick` é invisível para eles.
